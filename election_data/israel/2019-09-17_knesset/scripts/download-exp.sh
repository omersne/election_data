...
# download-exp.sh
# ------------------------------------------
# Download exported election data (Knesset 22, 2019-09-17) in CSV format.
# Based on the script for the previous election (Knesset 21, 2019-04-09): https://github.com/omersne/election_data/blob/master/election_data/israel/2019-04-09_knesset/scripts/download-exp.sh
#
# Usage:
#       download-exp.sh
#
...
URLS=( https://media22.bechirot.gov.il/files/exp{b,c}.csv )
