...
# download-exp.sh
# ------------------------------------------
# Download exported election data (Knesset 24, 2021-03-23) in CSV format.
# Based on the script for the previous election (Knesset 23, 2020-03-02): https://github.com/omersne/election_data/blob/master/election_data/israel/2020-03-02_knesset/scripts/download-exp.sh
#
# Usage:
#       download-exp.sh
#
...
URLS=( https://media24.bechirot.gov.il/files/exp{b,c}.csv )
